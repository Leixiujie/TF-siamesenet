...
flags.DEFINE_integer('train_iter', 50001, 'Total training iter')
flags.DEFINE_integer('validation_step', 10000, 'Total training iter')
flags.DEFINE_integer('step', 1000, 'Save after ... iteration')
flags.DEFINE_integer('DEV_NUMBER', -2000, '验证集数量')
flags.DEFINE_integer('batch_size', 2, '批大小')
