    ...
    for pic_name in files:
        ...
        if (enhancement):     
            ...
            for i in range(44,64):
                pixel_need_to_cut_left = np.random.randint(0,20)
                pixel_need_to_cut_right = np.random.randint(0,20)
                pixel_need_to_cut_top = np.random.randint(0,20)
                pixel_need_to_cut_bottom = np.random.randint(0,20)
                degree = np.random.randint(-60,60)
                image_new = (image.rotate(degree)).crop((pixel_need_to_cut_left,pixel_need_to_cut_top,72 - pixel_need_to_cut_right,72 - pixel_need_to_cut_bottom))
