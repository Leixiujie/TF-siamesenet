...
pics = []
image_ = tf.image.resize_images(image,(299,299),0)
pics.append(image_)

image1 = tf.image.resize_images(image,(299,299),1)
pics.append(image1)
...
while(crop_size < 200):
    ...
    croped = tf.image.resize_images(croped,(299,299),0)
    pics.append(croped)   
    ...
    with tf.Session() as sess:
      ...
      for pic_name in pic_all:
          ...
          for pic in transformed_pics:
              ...
              image__ = image__.resize((299,299))
              #image__.show()
